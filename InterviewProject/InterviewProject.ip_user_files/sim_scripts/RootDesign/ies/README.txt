...
#
# Generated by export_simulation on Thu Jan 21 21:40:28 -0700 2021
#
################################################################################
...
'-reset_run' switch to the './RootDesign.sh' script.

./RootDesign.sh -reset_run
...
./RootDesign.sh -noclean_files

For more information on the script, please type './RootDesign.sh -help'.
