...
HD_PWD='C:/Users/zapma/PiRadioInterview/InterviewProject/InterviewProject.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RootDesign_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RootDesign_wrapper.tcl
