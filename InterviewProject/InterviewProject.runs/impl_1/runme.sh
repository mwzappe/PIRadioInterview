...
HD_PWD='C:/Users/zapma/PiRadioInterview/InterviewProject/InterviewProject.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RootDesign_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RootDesign_wrapper.tcl -notrace
