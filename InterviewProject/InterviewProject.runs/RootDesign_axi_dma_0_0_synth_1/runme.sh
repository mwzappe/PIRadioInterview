...
HD_PWD='C:/Users/zapma/PiRadioInterview/InterviewProject/InterviewProject.runs/RootDesign_axi_dma_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RootDesign_axi_dma_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RootDesign_axi_dma_0_0.tcl
